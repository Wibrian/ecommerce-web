  ...
  const addProduct = async () => {
    ...
    if (responseData.success) {
      ...
      await fetch("http://localhost:4000/addproduct", {
        ...
        .then((resp) => resp.json())
        .then((data) => {
          data.success ? alert("Product Added") : alert("Failed to Upload");
        });
    }
  };
    ...
    <div className="p-8 box-border bg-white w-full rounded-sm mt-4 lg:m-7 ">
      <div className="mb-3">
        ...
        <input
          ...
          required
          className="bg-primary outline-none max-w-80 w-full px-4 py-3 rounded-md"
        />
      </div>
      <div className="mb-3">
      ...
      <div>
        <label htmlFor="file-input">
          <img src={image ? URL.createObjectURL(image) : upload_area} alt="upload" className="w-20 rounded-sm inline-block" />
